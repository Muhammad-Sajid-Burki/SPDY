...
class Past_1 extends StatefulWidget {
  @override
  _Past_1State createState() => _Past_1State();
}

class _Past_1State extends State<Past_1> {
            ...
            child: Stack(
              children: [
                Padding(
                  ...
                  child: Text("Past Orders", style: TextStyle(fontSize: 20, color: Colors.white, fontWeight: FontWeight.bold)),
                ),
                Padding(
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            FlatButton(
                              child: Row(
                                children: [
                                  Icon(Icons.navigate_before, color: Colors.white, size: 40,),
                                  Icon(Icons.navigate_before, color: Colors.white, size: 40,),
                                ],
                              ),
                              onPressed: () {
                            ...
                            Text("Page 1 of 10", style: TextStyle(color: Colors.white, fontSize: 15),),
                            FlatButton(
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                children: [
